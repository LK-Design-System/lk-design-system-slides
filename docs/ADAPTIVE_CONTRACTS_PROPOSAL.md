...
상태: **구현됨 — 변경 1–4 전면 활성** (2026-08-17 작성·같은 날 구현. 변경 3은
Core Stat의 `--lk-stat-*` 훅(업스트림 75b9e3b2, Table·Timeline 계약의 네 번째
사례)을 겨냥해 배선했고, 훅을 담은 rc.69.28로 핀을 올린 alpha.10에서 위성 코드
변경 없이 켜졌다 — 두 수치 StatSlide가 한 단 크게 인쇄된다)
